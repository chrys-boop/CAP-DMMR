...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
    header("Location: dashboard_instructor.php"); // Redirección por defecto para instructor
    exit();
}
...
// 4. --- REDIRECCIÓN ---
// Redirigir siempre de vuelta a la página de carga del instructor
header("Location: craga_oficio_intructor.php");
exit();
